...
class Learner(object):
    ...
    def create_lossOdeint(self):
        ...
        def lossOdeint(point):
            ...
            sigma=[]
            beta0, sigma01, sigma02, startT, startT2, sigma0,  a, b, d, p, betaR, mu = point
            gamma=a+b
            gamma2=d
    ...
    def create_lossSub(self,pointOrig):
        ...
        beta0, sigma01, sigma02, startT, startT2, sigma0,  a, b, d, p, betaR, mu = pointOrig
    ...
    def predict(self, point):
        ...
        beta0, sigma01, sigma02, startT, startT2, sigma0,  a, b, d, p, betaR, mu, sub, subDth  = point
    ...
    def train(self):
        ...
        #beta0, sigma01, sigma02, startT, startT2, sigma0,  a, b, d, p, betaR, mu
        
        bounds =[(1e-16, .9),(1e-16, .9),(1e-16, .9),(0,int(size*3/4+0.5)-1),(int(size*3/4+0.5),size-5),
            (1e-16, .9),(1e-16, .9),(1e-16, .9),(1e-16, .9),(0.01,0.99),(0,10),(1e-16,0.9)]
