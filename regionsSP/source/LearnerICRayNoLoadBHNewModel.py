...
class Learner(object):
    ...
    def create_lossOdeint(self):
        ...
        def lossOdeint(point):
            ...
            l3 = (np.mean(np.divide(res[ix[0],4],res[ix[0],3])-self.ratio))**2
#             l3 = np.mean((res[ix[0],4] - (self.recovered.values[ix]))**2)
    ...
    def train(self):
        ...
        (1/160, .4),(1e-12, .4),(1e-12, .4),(1e-12, .4),(1e-12, .4))# your bounds

        x0 = [1e-3, 1e-3, 0, 1e-3, 1/50, 1e-3, 1e-3, 1e-3, 1e-3]
