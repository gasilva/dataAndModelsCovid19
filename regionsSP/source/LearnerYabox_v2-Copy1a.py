...
MB=1024*1024
GB=MB*1024
ray.init(num_cpus=20) #,memory=150*GB,lru_evict=True)
    
#     object_store_memory=1*GB,memory=1*GB,\
...
class Learner(object):
    ...
    def create_lossOdeint(self,data,\
        ...
        def lossOdeint(point):
            ...
            #objective function
            gtot=u*(l1+0.05*dErrorI) + v*(l2*3.2+0.09*dErrorD) + w*l3
