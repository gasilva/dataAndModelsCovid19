...
class Learner(object):
    ...
    def create_lossOdeint(self):
        ...
        def lossOdeint(point):
            size = len(self.data)
            beta0, beta01, startT, beta2, sigma,  gamma,gamma2, mu = point
    ...
    def create_lossSub(self, p):
        ...
        beta0, beta01, startT, beta2, sigma, gamma,gamma2, mu  = p
    ...
    def predict(self, p):
        ...
        beta0, beta01, startT, beta2, sigma, gamma,gamma2, mu, sub, subRec, subDth  = p
