...
class Learner(object):
    ...
    def train(self):
        ...
        (1/160, .4),(1e-12, .4),(1e-12, .4),(1e-12, .4),(1e-12, .4),(1e-12, .4),(.2,1.1),(.2,1.1)) # your bounds

        x0 = [1e-3, 1e-3, 0, 1e-3, 1/120, 1/120, 1/120, 1e-3, 1e-3, 1e-3, 1e-3, 1e-3, 1, 1]
        minimizer_kwargs = { "method": "L-BFGS-B","bounds":bnds }
        optimal = basinhopping(f, x0, minimizer_kwargs=minimizer_kwargs,niter=10,disp=True)        
        
        point = self.s_0, self.start_date, self.i_0, self.d_0, self.r_0, \
                            self.startNCases, self.weigthCases, self.weigthRecov
