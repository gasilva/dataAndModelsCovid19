...
#0 simulation for fitting of IC
#broad bounds for weights 
#b only (no d) in recovered equation
#minimize in module with educated initial guess
#intention is to close this way
...
for country in countries:
    ...
    #average less standard deviation
    ...
    # simulate and plot with initial conditions
    # learner.train()
    # learner.trainPlot()
    ...
    #predict values with parameters
    ...
    #variables X to plot Zoom figure
